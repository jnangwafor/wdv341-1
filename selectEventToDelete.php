...
$sql = "SELECT event_id, event_name, event_description, event_presenter, DATE_FORMAT( event_time,'%l:%i %p' ), DATE_FORMAT( event_date,'%W %M %D, %Y' )";	
	...
	<p>
        <div class="eventBlock">
            ...
            <div>
				...
				<span><a href = "deleteEvent.php?recId=<?php echo $event_id; ?>">Delete</a> </span>
