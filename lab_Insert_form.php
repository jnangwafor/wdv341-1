	...
	if( isset($_POST['prod_submit']) )
	{
		...
		if($valid_form) {
				...
				try{
					...
					//create insert commands to input data into the datsbase
					...
					$sql.= ")VALUES (:prodName, :prodPrice, :prodColor, :prodWagon, :prodWagonOrdered)";
				...
				$statment->bindParam(':prodColor', $prod_color);		
				$statment->bindParam(':prodWagon', $prod_wagon);		
				$statment->bindParam(':prodWagonOrdered', $todaysDate);
